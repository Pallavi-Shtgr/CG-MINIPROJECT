...
void displayfirst(void){
    displayText(800, 600, 0, 0, 1,line1);
    displayText(800, 550, 0, 0, 0,line2);
    displayText(800, 500, 0, 0, 0,line3);
    displayText(80, 150, 1, 0, 0,line4);
    displayText(80, 100,0, 0, 0,line5);
    displayText(80, 50, 0, 0, 0,line6);
    displayText(1600,20,0,1,0,line7);
}
...
void display2(int pno1) //Display Gantt chart on terminal
{
    wt=wt+total;
    printf("-%d |%d| %d- \n",pt,pno1,total);
    p[pno1].ct=pt;
...
void constr() // To show text of the main page
{
    int p=15,q=200;
    glColor3f(1,1,1);
